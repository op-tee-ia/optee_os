...
#define MAX_ENFORCED_PARAMS_COUNT 50
#define MIN_MML 96
#define MAX_MML 128
...
static inline const char *TA_tag_to_str (keymaster_tag_t tag) {
	...
	TAG_TO_STR(KM_TAG_RSA_OAEP_MGF_DIGEST)
	TAG_TO_STR(KM_TAG_BLOB_USAGE_REQUIREMENTS)
	TAG_TO_STR(KM_TAG_ROLLBACK_RESISTANCE)
	TAG_TO_STR(KM_TAG_EARLY_BOOT_ONLY)
	TAG_TO_STR(KM_TAG_USAGE_COUNT_LIMIT)
	...
	TAG_TO_STR(KM_TAG_ATTESTATION_ID_BRAND)
	TAG_TO_STR(KM_TAG_ATTESTATION_ID_DEVICE)
	TAG_TO_STR(KM_TAG_ATTESTATION_ID_PRODUCT)
	TAG_TO_STR(KM_TAG_ATTESTATION_ID_SERIAL)
	TAG_TO_STR(KM_TAG_ATTESTATION_ID_IMEI)
	TAG_TO_STR(KM_TAG_ATTESTATION_ID_MEID)
	TAG_TO_STR(KM_TAG_ATTESTATION_ID_MANUFACTURER)
	TAG_TO_STR(KM_TAG_ATTESTATION_ID_MODEL)
	TAG_TO_STR(KM_TAG_VENDOR_PATCHLEVEL)
	TAG_TO_STR(KM_TAG_BOOT_PATCHLEVEL)
	TAG_TO_STR(KM_TAG_DEVICE_UNIQUE_ATTESTATION)
	TAG_TO_STR(KM_TAG_IDENTITY_CREDENTIAL_KEY)
	TAG_TO_STR(KM_TAG_ATTESTATION_ID_SECOND_IMEI)
