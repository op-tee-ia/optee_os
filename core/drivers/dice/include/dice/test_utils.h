...
const size_t kTestCertSize = 2048;
...
typedef struct DiceStateForTest {
...
// |suffix|.
void DumpState(enum CertificateType cert_type, KeyType key_type, const char* suffix,
...
void CreateFakeUdsCertificate(void* context, const uint8_t uds[32],
                              enum CertificateType cert_type, KeyType key_type,
                              uint8_t certificate[kTestCertSize],
                              size_t* certificate_size);
...
bool VerifyCertificateChain(enum CertificateType cert_type,
