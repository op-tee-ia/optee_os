...
link-script-dummy = core/arch/x86_64/kernel/link_dummy.ld
link-script = $(if $(wildcard $(platform-dir)/kern.ld.S), \
		$(platform-dir)/kern.ld.S, \
		core/arch/x86_64/kernel/kern.ld.S)
...
link-objs := $(filter-out $(out-dir)/core/arch/x86_64/kernel/link_dummies.o, \
			  $(objs))
